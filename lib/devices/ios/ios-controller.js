...
iOSController.complexTap = function (tapCount, touchCount, duration, x, y, elementId, cb) {
  ...
  if (this.useRobot) {
    var tapUrl = this.args.robotUrl + "/tap";
    request.post({url:tapUrl, form: options}, cb);
  } else {
...
iOSController.stopApp = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.replaceApp = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.removeFile = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.listFiles = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.broadcastIntent = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.isSoftKeyboardPresent = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.clearData = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.swipeUpHomeButton = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.getNavigationBarRegion = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.adbSwipe = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.adbTap = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.getDisplayMetrics = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.hasRoot = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.setDate = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.getDate = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.getDateString = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.adbInputText = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.getVersions = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.removeFolder = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.listFolder = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.getOwner = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.setOwner = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.cp = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.startAction = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.download = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.unzip = function (cb) {
  cb(new NotYetImplementedError(), null);
};

iOSController.setOwnerRecursively = function (cb) {
  cb(new NotYetImplementedError(), null);
};
