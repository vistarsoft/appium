...
module.exports = function (appium) {
  ...
  rest.get('/wd/hub/session/:sessionId?/appium/device/is_soft_keyboard_present', controller.isSoftKeyboardPresent);
  rest.post('/wd/hub/session/:sessionId?/appium/device/install_app', controller.installApp);
  rest.post('/wd/hub/session/:sessionId?/appium/device/replace_app', controller.replaceApp);
  rest.post('/wd/hub/session/:sessionId?/appium/device/stop_app', controller.stopApp);
  ...
  rest.post('/wd/hub/session/:sessionId?/appium/device/remove_file', controller.removeFile);
  rest.post('/wd/hub/session/:sessionId?/appium/device/remove_folder', controller.removeFolder);
  rest.post('/wd/hub/session/:sessionId?/appium/device/list_files', controller.listFiles);
  rest.post('/wd/hub/session/:sessionId?/appium/device/list_folder', controller.listFolder);
  ...
  rest.post('/wd/hub/session/:sessionId?/appium/device/broadcast_intent', controller.broadcastIntent);
  rest.post('/wd/hub/session/:sessionId?/appium/device/clear_data', controller.clearData);
  rest.post('/wd/hub/session/:sessionId?/appium/device/swipe_up_home_button', controller.swipeUpHomeButton);
  rest.get('/wd/hub/session/:sessionId?/appium/device/get_navigation_bar_region', controller.getNavigationBarRegion);
  rest.post('/wd/hub/session/:sessionId?/appium/device/adb_swipe', controller.adbSwipe);
  rest.post('/wd/hub/session/:sessionId?/appium/device/adb_tap', controller.adbTap);
  rest.post('/wd/hub/session/:sessionId?/appium/device/adb_input_text', controller.adbInputText);
  rest.get('/wd/hub/session/:sessionId?/appium/device/get_display_metrics', controller.getDisplayMetrics);
  rest.get('/wd/hub/session/:sessionId?/appium/device/has_root', controller.hasRoot);
  rest.get('/wd/hub/session/:sessionId?/appium/device/get_date', controller.getDate);
  rest.get('/wd/hub/session/:sessionId?/appium/device/get_date_string', controller.getDateString);
  rest.post('/wd/hub/session/:sessionId?/appium/device/get_versions', controller.getVersions);
  rest.post('/wd/hub/session/:sessionId?/appium/device/set_date', controller.setDate);
  rest.post('/wd/hub/session/:sessionId?/appium/device/get_owner', controller.getOwner);
  rest.post('/wd/hub/session/:sessionId?/appium/device/set_owner', controller.setOwner);
  rest.post('/wd/hub/session/:sessionId?/appium/device/cp', controller.cp);
  rest.post('/wd/hub/session/:sessionId?/appium/device/start_action', controller.startAction);
  rest.post('/wd/hub/session/:sessionId?/appium/device/run_adb_shell_command', controller.runAdbShellCommand);
  rest.post('/wd/hub/session/:sessionId?/appium/device/download', controller.download);
  rest.post('/wd/hub/session/:sessionId?/appium/device/unzip', controller.unzip);
  rest.post('/wd/hub/session/:sessionId?/appium/device/set_owner_recursively', controller.setOwnerRecursively);
